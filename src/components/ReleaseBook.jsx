...
const ReleaseBook = ({ books }) => {
  ...
  return (
    <div className='release-book-container' style={{ maxWidth: '1200px', margin: '0 auto' }}>
      <Slider {...settings}>
        {books.map((book, index) => (
          <div key={index} className="release-book" style={{ width: '150px', height: '250px' }}>
